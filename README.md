...
**Для AI агентів:** `../AI_DOCS/START_HERE.md` - головний файл з контекстом
...
**Для AI агентів:**
- `../AI_DOCS/START_HERE.md` - головний файл
- `../AI_DOCS/01_AI_AGENT_QUICK_START/HOW_TO_VIEW_LOGS.md` - токени, логи
