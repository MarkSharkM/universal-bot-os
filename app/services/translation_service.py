...
class TranslationService:
    ...
    GLOBAL_UI_DEFAULTS = {
        'uk': {
            ...
            'copied': '✅ Скопійовано!',
            'share_text_pro': '🚀 Долучайся до EarnHubAggregatorBot — отримуй зірки за активність!',
            'share_text_starter': "🚀 Долучайся до EarnHubAggregatorBot — отримуй зірки за активність!",
        ...
        'en': {
            ...
            'copied': '✅ Copied!',
            'share_text_pro': '🚀 Join EarnHubAggregatorBot — earn Stars for your activity!',
            'share_text_starter': "🚀 Join EarnHubAggregatorBot — earn Stars for your activity!",
        ...
        'ru': {
            ...
            'copied': '✅ Скопировано!',
            'share_text_pro': '🚀 Присоединяйся к EarnHubAggregatorBot — получай звёзды за активность!',
            'share_text_starter': "🚀 Присоединяйся к EarnHubAggregatorBot — получай звёзды за активность!",
        ...
        'de': {
            ...
            'footer_about_text': 'EarnHub ist ein Aggregator für Empfehlungsprogramme, der Boni für das Netzwerkwachstum bietet. Profitiere von der 7% Telegram-Monetarisierung und maximiere deine Erträge durch unsere Partner-Bots.',
            ...
            'copied': '✅ Kopiert!',
            'share_text_pro': '🚀 Tritt EarnHubAggregatorBot bei — sammle Stars für deine Aktivität!',
            'share_text_starter': "🚀 Tritt EarnHubAggregatorBot bei — sammle Stars für deine Aktivität!",
        ...
        'es': {
            ...
            'copied': '✅ ¡Copiado!',
            'share_text_pro': '🚀 ¡Únete a EarnHubAggregatorBot — gana Stars por tu actividad!',
            'share_text_starter': "🚀 ¡Únete a EarnHubAggregatorBot — gana Stars por tu actividad!",
