            ...
            try:
                ...
                log_data = BusinessDataModel(
                    ...
                    data={
                        ...
                        'earned_ton': decimal_to_float(parse_decimal(row.get('Earned TON', '0'))),
            ...
            try:
                ...
                partner_data = BusinessDataModel(
                    ...
                    data={
                        ...
                        'commission': decimal_to_float(parse_decimal(row.get('Commission (%)', '0'))),
                        'category': row.get('Category', 'NEW'),
                        'active': row.get('Active', 'Yes'),
                        'verified': row.get('Verified', 'Yes'),
                        'roi_score': decimal_to_float(parse_decimal(row.get('ROI Score', '0'))),
